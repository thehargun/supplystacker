...
var task = instance.newTask('split');
task.start()
    .then(function () {
    ...
    .then(function (pdfjpgTask) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: 
            // Process this task individually and download.
            return [4 /*yield*/, pdfjpgTask.process()];
            case 1:
                // Process this task individually and download.
                _a.sent();
                return [2 /*return*/, pdfjpgTask.download()];
        }
    });
}); })
    .then(function (data) {
